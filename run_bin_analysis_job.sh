#!/bin/bash
#SBATCH --job-name=Pattern_Spectra_Bin_Analysis-Rudolph-deletion
...
python -u Feature_Extraction/run_bin_analysis.py --variant Rudolph --combo R_V --eval_type deletion
