#!/bin/bash
#SBATCH --job-name=Pattern_Spectra_Bin_Analysis-Fontane-insertion
...
python -u Feature_Extraction/run_bin_analysis.py --variant Fontane --combo R_G_B_H_S_V --eval_type insertion
